...
class BertModel(nn.Module):
    ...
    def forward(self,
        ...
        # all_encoder_outputs have num_hidden_layers output
        sequence_output = all_encoder_outputs[-1]  # last layer
        # sequence_output: [src_len, batch_size, hidden_size]
        pooled_output = self.bert_pooler(sequence_output)
        # last layer's first token, [cls] after dense + tanh
